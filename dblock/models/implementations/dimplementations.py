...
class DBaseModel(BaseModel):
    ...
    def __init__(self, d, recurrent, method, t_len, n_neurons, n_layers=1, detach_recurrent_spikes=False, heterogeneous_beta=False, beta_requires_grad=True, readout_max=True, single_spike=True, skip_connections=False):
    ...
    def hyperparams(self):
        return {**super().hyperparams, "d": self._d, "detach_recurrent_spikes": self._detach_recurrent_spikes, "skip_connections": self._skip_connections}
...
class NMNISTDModel(DBaseModel):
    ...
    def __init__(self, d, recurrent, method, t_len, n_neurons, n_layers=1, detach_recurrent_spikes=False, heterogeneous_beta=False, beta_requires_grad=True, readout_max=True, single_spike=True, **kwargs):
        ...
        super().__init__(d, recurrent, method, t_len, n_neurons, n_layers, detach_recurrent_spikes, heterogeneous_beta, beta_requires_grad, readout_max, single_spike, kwargs.get("skip_connections", False))
